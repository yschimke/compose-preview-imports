# DroidKaigi 2026 — design artifacts

Importable sticker-sheet for **`droidkaigi-conference-app-2026`**, rendered from the committed
`@Preview` catalog in [`DroidKaigi/conference-app-2026`](https://github.com/DroidKaigi/conference-app-2026). This branch is a
**generated delivery artifact** — browse it in the page below, or pull it into
Figma / Stitch / Claude Design.

## 🔎 Browse the catalog

**[▶ Open the rendered catalog (htmlpreview)](https://htmlpreview.github.io/?https://github.com/DroidKaigi/conference-app-2026/blob/design-artifacts/droidkaigi-conference-app-2026/index.html)**
...
**[▶ Open the SVG↔PNG comparison (htmlpreview)](https://htmlpreview.github.io/?https://github.com/DroidKaigi/conference-app-2026/blob/design-artifacts/droidkaigi-conference-app-2026/compare.html)**
...
**[▶ Open this catalog in the live preview server](https://preview.coo.ee/droidkaigi-conference-app-2026/)**

The same rendered components, served live by `compose-preview serve --catalogs droidkaigi-conference-app-2026` —
...
| Library | — |
| Renderer | compose-preview 1.77.0 |
...
| Path | What it is |
| --- | --- |
| `index.html` | Self-contained gallery — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/DroidKaigi/conference-app-2026/blob/design-artifacts/droidkaigi-conference-app-2026/index.html) |
| `compare.html` | SVG↔PNG comparison with a live structural-similarity score — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/DroidKaigi/conference-app-2026/blob/design-artifacts/droidkaigi-conference-app-2026/compare.html) |
...
- **Customise** — open the [live preview server](https://preview.coo.ee/droidkaigi-conference-app-2026/) (or any image's `livePreview` link in `catalog.json`) to re-render a component under different themes / locales / devices.
...
Generated by the [`Design Artifacts`](https://github.com/DroidKaigi/conference-app-2026/actions/workflows/design-artifacts.yml)
