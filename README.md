# Bitwarden — design artifacts

Importable sticker-sheet for **`bitwarden-android`**, rendered from the committed
`@Preview` catalog in [`bitwarden/android`](https://github.com/bitwarden/android). This branch is a
**generated delivery artifact** — browse it in the page below, or pull it into
Figma / Stitch / Claude Design.

## 🔎 Browse the catalog

**[▶ Open the rendered catalog (htmlpreview)](https://htmlpreview.github.io/?https://github.com/bitwarden/android/blob/design-artifacts/bitwarden-android/index.html)**
...
**[▶ Open the SVG↔PNG comparison (htmlpreview)](https://htmlpreview.github.io/?https://github.com/bitwarden/android/blob/design-artifacts/bitwarden-android/compare.html)**
...
**[▶ Open this catalog in the live preview server](https://preview.coo.ee/bitwarden-android/)**

The same rendered components, served live by `compose-preview serve --catalogs bitwarden-android` —
...
| Group | Count |
| --- | ---: |
| Cards and content | 10 |
| Buttons | 8 |
| Fields | 7 |
| Dialogs and feedback | 7 |
| Rows and lists | 6 |
| App bars | 6 |
| Accounts | 4 |
| Foundations | 1 |
...
| Path | What it is |
| --- | --- |
| `index.html` | Self-contained gallery — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/bitwarden/android/blob/design-artifacts/bitwarden-android/index.html) |
| `compare.html` | SVG↔PNG comparison with a live structural-similarity score — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/bitwarden/android/blob/design-artifacts/bitwarden-android/compare.html) |
...
- **Customise** — open the [live preview server](https://preview.coo.ee/bitwarden-android/) (or any image's `livePreview` link in `catalog.json`) to re-render a component under different themes / locales / devices.
...
Generated by the [`Design Artifacts`](https://github.com/bitwarden/android/actions/workflows/design-artifacts.yml)
