# Horologist — design artifacts

Importable sticker-sheet for **`com.google.android.horologist`**, rendered from the committed
`@Preview` catalog in [`google/horologist`](https://github.com/google/horologist). This branch is a
**generated delivery artifact** — browse it in the page below, or pull it into
Figma / Stitch / Claude Design.

## 🔎 Browse the catalog

**[▶ Open the rendered catalog (htmlpreview)](https://htmlpreview.github.io/?https://github.com/google/horologist/blob/design-artifacts/horologist/index.html)**
...
**[▶ Open the SVG↔PNG comparison (htmlpreview)](https://htmlpreview.github.io/?https://github.com/google/horologist/blob/design-artifacts/horologist/compare.html)**
...
**[▶ Open this catalog in the live preview server](https://preview.coo.ee/horologist/)**

The same rendered components, served live by `compose-preview serve --catalogs horologist` —
...
| Chips | 7 |
| Media components | 7 |
| Devices - Small Square | 7 |
| Audio | 5 |
| Devices - Small Round | 5 |
| Phone sheets | 4 |
| Pickers | 3 |
| Health | 3 |
| Fonts - Largest | 3 |
...
| Path | What it is |
| --- | --- |
| `index.html` | Self-contained gallery — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/google/horologist/blob/design-artifacts/horologist/index.html) |
| `compare.html` | SVG↔PNG comparison with a live structural-similarity score — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/google/horologist/blob/design-artifacts/horologist/compare.html) |
...
- **Customise** — open the [live preview server](https://preview.coo.ee/horologist/) (or any image's `livePreview` link in `catalog.json`) to re-render a component under different themes / locales / devices.
...
Generated by the [`Design Artifacts`](https://github.com/google/horologist/actions/workflows/design-artifacts.yml)
