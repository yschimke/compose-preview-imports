...
`@Preview` catalog in [`Automattic/pocket-casts-android`](https://github.com/Automattic/pocket-casts-android). This branch is a
**generated delivery artifact** — browse it in the page below, or pull it into
Figma / Stitch / Claude Design.

## 🔎 Browse the catalog

**[▶ Open the rendered catalog (htmlpreview)](https://htmlpreview.github.io/?https://github.com/Automattic/pocket-casts-android/blob/design-artifacts/pocketcasts-wear/index.html)**
...
**[▶ Open the SVG↔PNG comparison (htmlpreview)](https://htmlpreview.github.io/?https://github.com/Automattic/pocket-casts-android/blob/design-artifacts/pocketcasts-wear/compare.html)**
...
| Path | What it is |
| --- | --- |
| `index.html` | Self-contained gallery — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/Automattic/pocket-casts-android/blob/design-artifacts/pocketcasts-wear/index.html) |
| `compare.html` | SVG↔PNG comparison with a live structural-similarity score — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/Automattic/pocket-casts-android/blob/design-artifacts/pocketcasts-wear/compare.html) |
...
Generated by the [`Design Artifacts`](https://github.com/Automattic/pocket-casts-android/actions/workflows/design-artifacts.yml)
