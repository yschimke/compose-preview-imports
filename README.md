...
Importable sticker-sheet for **`thunderbird-android`**, rendered from the committed
`@Preview` catalog in [`thunderbird/thunderbird-android`](https://github.com/thunderbird/thunderbird-android). This branch is a
**generated delivery artifact** — browse it in the page below, or pull it into
Figma / Stitch / Claude Design.

## 🔎 Browse the catalog

**[▶ Open the rendered catalog (htmlpreview)](https://htmlpreview.github.io/?https://github.com/thunderbird/thunderbird-android/blob/design-artifacts/thunderbird-android/index.html)**
...
**[▶ Open the SVG↔PNG comparison (htmlpreview)](https://htmlpreview.github.io/?https://github.com/thunderbird/thunderbird-android/blob/design-artifacts/thunderbird-android/compare.html)**
...
**[▶ Open this catalog in the live preview server](https://preview.coo.ee/thunderbird-android/)**

The same rendered components, served live by `compose-preview serve --catalogs thunderbird-android` —
...
| Path | What it is |
| --- | --- |
| `index.html` | Self-contained gallery — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/thunderbird/thunderbird-android/blob/design-artifacts/thunderbird-android/index.html) |
| `compare.html` | SVG↔PNG comparison with a live structural-similarity score — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/thunderbird/thunderbird-android/blob/design-artifacts/thunderbird-android/compare.html) |
...
- **Customise** — open the [live preview server](https://preview.coo.ee/thunderbird-android/) (or any image's `livePreview` link in `catalog.json`) to re-render a component under different themes / locales / devices.
...
Generated by the [`Design Artifacts`](https://github.com/thunderbird/thunderbird-android/actions/workflows/design-artifacts.yml)
