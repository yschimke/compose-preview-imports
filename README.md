# Mullvad VPN — design artifacts

Importable sticker-sheet for **`mullvad-mullvadvpn-app`**, rendered from the committed
`@Preview` catalog in [`mullvad/mullvadvpn-app`](https://github.com/mullvad/mullvadvpn-app). This branch is a
**generated delivery artifact** — browse it in the page below, or pull it into
Figma / Stitch / Claude Design.

## 🔎 Browse the catalog

**[▶ Open the rendered catalog (htmlpreview)](https://htmlpreview.github.io/?https://github.com/mullvad/mullvadvpn-app/blob/design-artifacts/mullvad-mullvadvpn-app/index.html)**
...
**[▶ Open the SVG↔PNG comparison (htmlpreview)](https://htmlpreview.github.io/?https://github.com/mullvad/mullvadvpn-app/blob/design-artifacts/mullvad-mullvadvpn-app/compare.html)**
...
**[▶ Open this catalog in the live preview server](https://preview.coo.ee/mullvad-mullvadvpn-app/)**

The same rendered components, served live by `compose-preview serve --catalogs mullvad-mullvadvpn-app` —
...
| Path | What it is |
| --- | --- |
| `index.html` | Self-contained gallery — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/mullvad/mullvadvpn-app/blob/design-artifacts/mullvad-mullvadvpn-app/index.html) |
| `compare.html` | SVG↔PNG comparison with a live structural-similarity score — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/mullvad/mullvadvpn-app/blob/design-artifacts/mullvad-mullvadvpn-app/compare.html) |
...
- **Customise** — open the [live preview server](https://preview.coo.ee/mullvad-mullvadvpn-app/) (or any image's `livePreview` link in `catalog.json`) to re-render a component under different themes / locales / devices.
...
Generated by the [`Design Artifacts`](https://github.com/mullvad/mullvadvpn-app/actions/workflows/design-artifacts.yml)
