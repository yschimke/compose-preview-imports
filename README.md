# KotlinConf — design artifacts

Importable sticker-sheet for **`jetbrains-kotlinconf-app`**, rendered from the committed
`@Preview` catalog in [`JetBrains/kotlinconf-app`](https://github.com/JetBrains/kotlinconf-app). This branch is a
**generated delivery artifact** — browse it in the page below, or pull it into
Figma / Stitch / Claude Design.

## 🔎 Browse the catalog

**[▶ Open the rendered catalog (htmlpreview)](https://htmlpreview.github.io/?https://github.com/JetBrains/kotlinconf-app/blob/design-artifacts/jetbrains-kotlinconf-app/index.html)**
...
**[▶ Open the SVG↔PNG comparison (htmlpreview)](https://htmlpreview.github.io/?https://github.com/JetBrains/kotlinconf-app/blob/design-artifacts/jetbrains-kotlinconf-app/compare.html)**
...
**[▶ Open this catalog in the live preview server](https://preview.coo.ee/jetbrains-kotlinconf-app/)**

The same rendered components, served live by `compose-preview serve --catalogs jetbrains-kotlinconf-app` —
...
| Group | Count |
| --- | ---: |
| Navigation and headers | 17 |
| Buttons and actions | 13 |
| Search and filters | 13 |
| Feedback and state | 13 |
| Foundations and Kodee | 12 |
| Schedule and content cards | 11 |

## What's in this branch

| Path | What it is |
| --- | --- |
| `index.html` | Self-contained gallery — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/JetBrains/kotlinconf-app/blob/design-artifacts/jetbrains-kotlinconf-app/index.html) |
| `compare.html` | SVG↔PNG comparison with a live structural-similarity score — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/JetBrains/kotlinconf-app/blob/design-artifacts/jetbrains-kotlinconf-app/compare.html) |
...
- **Customise** — open the [live preview server](https://preview.coo.ee/jetbrains-kotlinconf-app/) (or any image's `livePreview` link in `catalog.json`) to re-render a component under different themes / locales / devices.
...
Generated by the [`Design Artifacts`](https://github.com/JetBrains/kotlinconf-app/actions/workflows/design-artifacts.yml)
