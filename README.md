# Twine — design artifacts

Importable sticker-sheet for **`msasikanth-twine`**, rendered from the committed
`@Preview` catalog in [`msasikanth/twine`](https://github.com/msasikanth/twine). This branch is a
**generated delivery artifact** — browse it in the page below, or pull it into
Figma / Stitch / Claude Design.

## 🔎 Browse the catalog

**[▶ Open the rendered catalog (htmlpreview)](https://htmlpreview.github.io/?https://github.com/msasikanth/twine/blob/design-artifacts/msasikanth-twine/index.html)**
...
**[▶ Open the SVG↔PNG comparison (htmlpreview)](https://htmlpreview.github.io/?https://github.com/msasikanth/twine/blob/design-artifacts/msasikanth-twine/compare.html)**
...
**[▶ Open this catalog in the live preview server](https://preview.coo.ee/msasikanth-twine/)**

The same rendered components, served live by `compose-preview serve --catalogs msasikanth-twine` —
...
| Path | What it is |
| --- | --- |
| `index.html` | Self-contained gallery — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/msasikanth/twine/blob/design-artifacts/msasikanth-twine/index.html) |
| `compare.html` | SVG↔PNG comparison with a live structural-similarity score — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/msasikanth/twine/blob/design-artifacts/msasikanth-twine/compare.html) |
...
- **Customise** — open the [live preview server](https://preview.coo.ee/msasikanth-twine/) (or any image's `livePreview` link in `catalog.json`) to re-render a component under different themes / locales / devices.
...
Generated by the [`Design Artifacts`](https://github.com/msasikanth/twine/actions/workflows/design-artifacts.yml)
