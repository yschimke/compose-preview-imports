# PeopleInSpace — design artifacts

Importable sticker-sheet for **`joreilly-peopleinspace`**, rendered from the committed
`@Preview` catalog in [`joreilly/PeopleInSpace`](https://github.com/joreilly/PeopleInSpace). This branch is a
**generated delivery artifact** — browse it in the page below, or pull it into
Figma / Stitch / Claude Design.

## 🔎 Browse the catalog

**[▶ Open the rendered catalog (htmlpreview)](https://htmlpreview.github.io/?https://github.com/joreilly/PeopleInSpace/blob/design-artifacts/joreilly-peopleinspace/index.html)**
...
**[▶ Open the SVG↔PNG comparison (htmlpreview)](https://htmlpreview.github.io/?https://github.com/joreilly/PeopleInSpace/blob/design-artifacts/joreilly-peopleinspace/compare.html)**
...
**[▶ Open this catalog in the live preview server](https://preview.coo.ee/joreilly-peopleinspace/)**

The same rendered components, served live by `compose-preview serve --catalogs joreilly-peopleinspace` —
...
| Library | — |
| Renderer | compose-preview 1.56.2 |
...
| Path | What it is |
| --- | --- |
| `index.html` | Self-contained gallery — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/joreilly/PeopleInSpace/blob/design-artifacts/joreilly-peopleinspace/index.html) |
| `compare.html` | SVG↔PNG comparison with a live structural-similarity score — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/joreilly/PeopleInSpace/blob/design-artifacts/joreilly-peopleinspace/compare.html) |
...
- **Customise** — open the [live preview server](https://preview.coo.ee/joreilly-peopleinspace/) (or any image's `livePreview` link in `catalog.json`) to re-render a component under different themes / locales / devices.
...
Generated by the [`Design Artifacts`](https://github.com/joreilly/PeopleInSpace/actions/workflows/design-artifacts.yml)
